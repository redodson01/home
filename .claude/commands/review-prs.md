...
Provide your feedback to me here and **wait for my explicit go-ahead before posting anything to a PR.** Check each draft against `~/.claude/CLAUDE.md` and `~/.claude/output-styles/neutral.md` before you show it.
